...
class Soczed_Less_Model_Observer
{
    ...
    public function beforeLayoutRender($observer)
    {
        ...
        if (($head = $layout->getBlock('head'))
            ...
            "header_background_color" => Mage::getStoreConfig('themeoptions_theming/theme_header/header_background_color', $storeId),
            "header_background_search" => Mage::getStoreConfig('themeoptions_theming/theme_header/header_background_search', $storeId),
            "header_text_color" => Mage::getStoreConfig('themeoptions_theming/theme_header/header_text_color', $storeId),
            "header_link_color" => Mage::getStoreConfig('themeoptions_theming/theme_header/header_link_color', $storeId),
            "header_link_hover_color" => Mage::getStoreConfig('themeoptions_theming/theme_header/header_link_hover_color', $storeId),
            "header_active_color" => Mage::getStoreConfig('themeoptions_theming/theme_header/header_active_color', $storeId),
            ...
            "l_new_menu_color" => Mage::getStoreConfig('themeoptions_theming/theme_body/l_new_menu_color', $storeId),
            "l_hot_menu_color" => Mage::getStoreConfig('themeoptions_theming/theme_body/l_hot_menu_color', $storeId),
            ...
            foreach ($newItems as $key => $item) {
                if (in_array($item['type'], array('js_css', 'skin_css'))) {
                    ...
                    if (substr($item['name'], -5) == '.less') {
                        ...
                        $cssFile  = substr($lessFile, 0, -5) . '_css_store_id_'.$storeId.'.css';          
                        //die();            
                        try {
                            // Init file config
                        ...
                        $newItems[$key]['name'] = substr($item['name'], 0, -5) . '_css_store_id_'.$storeId.'.css';
                    }
                }
            }
