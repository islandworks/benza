<?php
class Islandworks_FacebookConnect_CustomerController extends Mage_Core_Controller_Front_Action {
    ...
    public function LoginAction()
    {
        ...
        $cookie = $this->get_facebook_cookie(Mage::getStoreConfig('facebookconnect/settings/appid'), Mage::getStoreConfig('facebookconnect/settings/secret'));
        ...
        if (!is_null($me)) {
            ...
            $sql = 'SELECT `customer_id`
					FROM `' . $tablePrefix . 'islandworks_facebook_customer`
					WHERE `fb_id` = ' . $me['id'] . '
					LIMIT 1';
            ...
            if ($data) {
                ...
                if ($r) {
                    ...
                    $sql = 'INSERT INTO `' . $tablePrefix . 'islandworks_facebook_customer`
