...
class Islandworks_Blog_Block_Manage_Comment_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection->getSelect()->joinLeft(array('Islandworks_Blog_main' => $collection->getTable('blog/blog')), 'main_table.post_id=Islandworks_Blog_main.post_id', array('Islandworks_Blog_main.title'));
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('Islandworks_Blog_main.post_id', array(
