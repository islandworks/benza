...
class Islandworks_Blog_Block_Menu_Sidebar extends Islandworks_Blog_Block_Abstract
{
    ...
    protected function _toHtml()
    {
        if (self::$_helper->getEnabled()) {
            ...
            $isBlogPage = Mage::app()->getRequest()->getModuleName() == Islandworks_Blog_Helper_Data::DEFAULT_ROOT;
