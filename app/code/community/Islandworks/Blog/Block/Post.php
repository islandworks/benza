...
class Islandworks_Blog_Block_Post extends Islandworks_Blog_Block_Abstract
{
    ...
    public function getBookmarkHtml($post)
    {
        if ($this->_helper()->isBookmarksPost()) {
            return $this->setTemplate('Islandworks_Blog/bookmark.phtml')->setPost($post)->renderView();
        }
    }
