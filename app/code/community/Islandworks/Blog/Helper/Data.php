...
class Islandworks_Blog_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    {
        return Mage::getStoreConfig('blog/blog/enabled') && $this->extensionEnabled('Islandworks_Blog');
    }
