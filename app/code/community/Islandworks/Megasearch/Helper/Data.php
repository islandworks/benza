<?php
class Islandworks_Megasearch_Helper_Data extends Mage_Core_Helper_Abstract
{
    const XML_PATH_SHOW_SUBCATEGORIES                = 'megasearch/settings/show_subcategories';
    const XML_PATH_SUBCATEGORIES_LEVEL                = 'megasearch/settings/subcategories_level';
    const XML_PATH_INDENTATION_TEXT                  = 'megasearch/settings/indentation_text';
    const XML_PATH_SELECT_CATEGORY_ON_CATEGORY_PAGES = 'megasearch/settings/select_category_on_category_pages';
