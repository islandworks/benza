jQuery(function() {
	...
	/* jQuery(".item").hover(function() {
		jQuery(".islandworks-quick-act", this).transition({y: '-40px'});
	}, function() {
		jQuery(".islandworks-quick-act", this).transition({y: '0'});
	});	
	*/	
	// Sort by dropdown
   ...
   jQuery('.act-quickview-button').on('mouseenter', function(){
   	...
   	//Video
   	jQuery(".islandworks-video").colorbox({iframe:true, innerWidth:"99%", innerHeight:"100%",opacity:0.7,close: "<i class=\"fa fa-times-circle\"></i>"});
	...
	// Islandworks Animation
	jQuery('.islandworks-animation').waypoint(function() {
